...
CREATE TABLE `cm_balance` (
  ...
  `balance` decimal(12,3) unsigned DEFAULT '0.000' COMMENT '余额=可用+冻结',
...
CREATE TABLE `cm_menu` (
  ...
  `create_time` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 COMMENT='基本菜单表';
...
INSERT INTO `cm_menu` VALUES ('29', '25', '100', '渠道统计', 'admin', 'Orders/channel', '0', '', '1', '1544362599', '1539583897');
...
INSERT INTO `cm_menu` VALUES ('54', '0', '100', '测试菜单', 'admin', 'Test', '0', 'template-1', '1', '1544362688', '1544362688');
INSERT INTO `cm_menu` VALUES ('55', '54', '100', 'Level1', 'admin', 'Test/Level1', '0', '', '1', '1544362718', '1544362718');
