...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='商户信息表';

-- ----------------------------
-- Records of cm_api
-- ----------------------------
INSERT INTO `cm_api` VALUES ('1', '100001', '772ae1d32322f49508307b2f31a0107f', '小红帽', 'https://www.redcap.cn', '20000.00', '', '2', '1', '1541787044', '1543303677');
...
-- ----------------------------
INSERT INTO `cm_balance` VALUES ('1', '100001', '0.00', '0.10', '0.00', '1', '1541787044', '1542617892');
...
-- ----------------------------
INSERT INTO `cm_config` VALUES ('1', 'seo_title', '网站标题', '1', '1', '1', '聚合支付', '', '', '1', '1378898976', '1542443678');
INSERT INTO `cm_config` VALUES ('8', 'email_port', 'SMTP端口号', '1', '8', '2', '465', '', '如：一般为 25 或 465', '1', '0', '1540556601');
INSERT INTO `cm_config` VALUES ('2', 'seo_description', '网站描述', '2', '3', '1', 'Caomao|草帽聚合|ThinkPHP5|Cmpay聚合支付', '', '网站搜索引擎描述，优先级低于SEO模块', '1', '1378898976', '1542443678');
INSERT INTO `cm_config` VALUES ('3', 'seo_keywords', '网站关键字', '2', '4', '1', 'Caomao,ThinkPHP5,Cmpay聚合支付', '', '网站搜索引擎关键字，优先级低于SEO模块', '1', '1378898976', '1542443678');
INSERT INTO `cm_config` VALUES ('4', 'app_index_title', '首页标题', '1', '2', '1', '小红帽科技|草帽聚合支付|Cmpay聚合支付', '', '', '1', '1378898976', '1542443678');
INSERT INTO `cm_config` VALUES ('5', 'app_domain', '网站域名', '1', '5', '1', 'http://www.caomao.com', '', '网站域名', '1', '1378898976', '1542443678');
INSERT INTO `cm_config` VALUES ('6', 'app_copyright', '版权信息', '2', '6', '1', '© 2018聚合支付. ', '', '版权信息', '1', '1378898976', '1542443678');
...
INSERT INTO `cm_menu` VALUES ('53', '18', '100', '商户认证', 'admin', 'User/auth', '0', '', '1', '1542882201', '1542882201');
...
-- ----------------------------
INSERT INTO `cm_notice` VALUES ('1', '一个正经的标题', 'admin', '我特么是个通知，没啥好通知的，就是测试一下O不Ok!\n我特么是个通知，没啥好通知的，就是测试一下O不Ok!\n我特么是个通知，没啥好通知的，就是测试一下O不Ok!\n我特么是个通知，没啥好通知的，就是测试一下O不Ok!\n我特么是个通知，没啥好通知的，就是测试一下O不Ok!\n我特么是个通知，没啥好通知的，就是测试一下O不Ok!\n我特么是个通知，没啥好通知的，就是测试一下O不Ok!\n我特么是个通知，没啥好通知的，就是测试一下O不Ok!', '1', '1542704381', '1542882055');
...
CREATE TABLE `cm_pay_code` (
  ...
  `update_time` int(10) unsigned NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='交易方式表';

-- ----------------------------
-- Records of cm_pay_code
-- ----------------------------
INSERT INTO `cm_pay_code` VALUES ('1', '1', '微信扫码支付', 'wx.scan', '微信扫码支付', '1', '1535983487', '1543037898');
...
-- Records of cm_user
-- ----------------------------
INSERT INTO `cm_user` VALUES ('100001', 'nouser@iredcap.cn', 'Nouser', '3e7fb8e42b6be5e3c6b69f3597cb6ff7', '7a563bd96286403ca906e99727283cd5', '18078687485', '702154416', '1', '1', '1', '1', '1541787044', '1543309021');
...
-- ----------------------------
INSERT INTO `cm_user_account` VALUES ('1', '100001', '1', '18078687485', '支付宝', '', '1', '1', '1543302498', '1543303177');
...
-- ----------------------------
INSERT INTO `cm_user_auth` VALUES ('1', '100001', '马大哈', '554612198802051515', '[\"\\/uploads\\/userauth\\/100001\\/20181122\\/22203963968.jpg\",\"\\/uploads\\/userauth\\/100001\\/20181122\\/22204161001.jpg\"]', '2', '1542896443', '1542896771');
